...
Note:  This is a fork, from BitBucket.org (which won't let me set up an account), that resolves a compliation problem on Ubuntu 22.04 (Linux):  https://bitbucket.org/andreyu/simple-viewer-gl.git
...
```bash
$ git clone https://www.github.com/randolf/simple-viewer-gl.git
$ cd simple-viewer-gl
$ make release
```
